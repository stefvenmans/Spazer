...
//Constructor of the AudioProcessorEditor. All Slider, buttons, ... are initialized in here and are connected to the corresponding AudioProcessorValueTreeState parameters.
...
//The custom look and feels need to set back to a nullptr. Otherwise a memory leak will ocour.
...
//The paint functions handels the graphical figures of the Gui. It draws text and lines for example.
...
//This functions places the Gui objects at specific locations on the canvas.
