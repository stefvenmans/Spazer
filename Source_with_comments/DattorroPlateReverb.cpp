...
//Creates a Dattoro plate reverb object and initializes all the nececery vectors which contain the filter objects.
...
//Returns a singe sample processes by the reverb scheme.
...
//Takes a AudioBuffer object, processes the input samples of this buffer with the reverb scheme and writes them back into the output samples of the buffer.
...
//Set the modulation state of the modulated all-pass filters. If newState is true, modulation will be turned on.
